     ...
     <?php 
         ...
         if(isset($_POST['send_msg'])){
             ...
             if($msg==""){
                 ...
                 echo "<h4 style='color:red;text-align:center;'>Message is too
                 long! Use only 37 characters</h4>";
             }else{
                $insert = "insert into user_messages(user_to,user_from,msg_body,
                date,msg_seen) values ('$user_to_msg','$user_from_msg','$msg',NOW(),'no')";
             ...
             <div class='row'>
                  ...
                  <div style='background-color : #e6e6e6;' class='col-sm-9'>
                    ...
                    <ul class='list-group'>
                         ...
                         <li class='list-group-item' title='User Registartion Date'>
                         $register_date</li>
...
<script>
   var div=documnet.getElementById("scroll_messages");
