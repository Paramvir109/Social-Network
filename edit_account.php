...
<div class="row">
   ...
   <div class="col-sm-8">
      ...
      <table class="table table-bordered table-hover">
         <tr align="center">
             <tf colspan="6" class="active"><h2>Edit Your Profile</h2></td>
         ...
         <tr>
         <td style="font-weight:hold;">Description</td>
         ...
         <tr>
         <td style="font-weight:hold;">Relationship Status</td>
         ...
         <td style="font-weight:hold;">Country</td>
         ...
         <td style="font-weight:hold;">Gender</td>
...
<?php
    if(isset($_POST['update'])){
        ...
        $update = "update users set f_name='$f_name',l_name='$l_name',describe_user='$describe_user',user_name='$u_name',Relationship='$Relationship_status',
        user_pass='$u_pass',user_email='$u_email',user_country='$u_country',user_birthday='$u_birthday',user_gender='$u_gender'
